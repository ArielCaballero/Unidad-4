...
class Aplicacion():
    ...
    def __init__(self):
        ...
        Button(frame5, text="Calcular", bg="gray", relief='flat',command=self.calcular).pack(side=LEFT, fill=BOTH, expand=True,padx=5, pady=5)
        Button(frame5, text="Salir", bg="gray", relief='flat',command=self.salir).pack(side=RIGHT, fill=BOTH, expand=True,padx=5, pady=5)
